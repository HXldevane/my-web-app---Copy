import { drawSplines, createCuspToSpotCurve } from "./lines.js";
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    drawLinesBtn.addEventListener("click", () => {
        if (points.every((point, index) => (index === 2 || (point.x !== null && point.y !== null)))) {
            ...
            const { outlines, curves } = drawSplines(ctx, allPoints, minRadius, true);
            ...
            console.log("Cusp-to-Spot Curve:", cuspToSpotCurve);
