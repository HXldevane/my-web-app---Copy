...
import { checkPathIntersections, plotIntersections } from "./rules.js"; // Import the new function
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    drawLinesBtn.addEventListener("click", () => {
        if (points.every((point, index) => (index === 2 || (point.x !== null && point.y !== null)))) {
            ...
            checkPathIntersections(outlines, loadShapePoints);

            // Plot dots at intersection points
            plotIntersections(ctx, outlines, loadShapePoints);
